...
public class RubyLexerLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"COMMA", "SEMICOLON", "CRLF", "REQUIRE", "END", "DEF", "RETURN", "IF", 
			"ELSE", "ELSIF", "UNLESS", "WHILE", "RETRY", "BREAK", "FOR", "TRUE", 
	...
	public RubyLexerLexer(CharStream input) {
		super(input);
